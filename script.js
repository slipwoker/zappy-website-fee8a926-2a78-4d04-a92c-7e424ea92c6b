document.addEventListener('DOMContentLoaded', function() {
  ...
  function validateField(field) {
    ...
    if (isRequired && value === '') {
      ...
      } else if ((type === 'text' || field.tagName === 'INPUT') && value.length < 2) {
        isValid = false;
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('input', function(e) {
      ...
      if (field && (field.type === 'email' || field.type === 'tel' || field.type === 'text' || field.tagName === 'TEXTAREA')) {
        validateField(field);
      }
    });
    ...
    contactForm.addEventListener('submit', function(e) {
      ...
      fields.forEach(function(field) {
        if (field.type === 'email' || field.type === 'tel' || field.type === 'text' || field.tagName === 'TEXTAREA' || field.hasAttribute('required')) {
      ...
      if (allValid) {
        ...
        setTimeout(function() {
          contactForm.reset();
          contactForm.querySelectorAll('.input-valid').forEach(function(el) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'fee8a926-2a78-4d04-a92c-7e424ea92c6b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'fee8a926-2a78-4d04-a92c-7e424ea92c6b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'fee8a926-2a78-4d04-a92c-7e424ea92c6b';
